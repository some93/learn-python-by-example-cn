...
print(text_token)  # 5L2g5aW977yMUHl0aG9u
print(base64.b64decode(text_token).decode("utf-8"))  # 你好，Python
...
print(binary_token)  # AP8QIIA=
print(list(base64.b64decode(binary_token)))  # [0, 255, 16, 32, 128]
...
print(standard)  # b'++//'
print(url_safe)  # b'--__'
print(base64.urlsafe_b64decode(url_safe))  # b'\xfb\xef\xff'
...
print(token)  # dXNlcjo0Mg
print(restored)  # b'user:42'
...
print(visible)  # cGFzc3dvcmQ9MTIzNDU2
print(base64.b64decode(visible).decode("utf-8"))  # password=123456
...
print(f"原始: {len(original)} 字节")  # 原始: 100 字节
print(f"编码后: {len(encoded)} 字节")  # 编码后: 136 字节
```
